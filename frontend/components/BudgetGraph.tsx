    ...
    <div>
      <ResponsiveContainer width="100%" height={400} aspect={1.2}>
        <LineChart className={styles.chart} data={createTotalBudgetData()} margin={{ top: 20, right: 50, bottom: 0, left: 20 }}>
          <Line strokeWidth="5" type="monotone" dataKey="amount" stroke="blue" />
          <Line strokeWidth="5" type="monotone" dataKey="budget" stroke="red" />
          <Line strokeWidth="5" type="monotone" dataKey="amountPrediction" stroke="purple" strokeDasharray="5 5" />
